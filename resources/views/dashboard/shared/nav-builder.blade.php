...
?>
      ...
      <div class="c-sidebar-brand"><img class="c-sidebar-brand-full" src="{{ ('/assets/img/garlic.png') }}" width="46" height="46" alt="CoreUI Logo"><img class="c-sidebar-brand-minimized" src="assets/img/garlic.png" width="46" height="46" alt="CoreUI Logo"><h1>Verticallium</h1></div>
